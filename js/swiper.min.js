...
$(document).ready(function() {
    ...
    $('.seoIcerik').each(function() {
        ...
        if(content.length > showChar) {
            ...
            var html = c + '<span class="ucNoktaKoy">' + ellipsestext+ '&nbsp;</span><span class="seoIcerikGizle"><span>' + h + '</span>&nbsp;&nbsp;<a href="" class="seoIcerikLink">' + moretext + '</a></span>';
